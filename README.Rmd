...
In such an analysis, you might focus on one attribute, such as gender, and examine whether the decline was driven by the male users, the female users, or both.
...
From this plot, we can see that the decline in CTR is primarily driven by the male users.
