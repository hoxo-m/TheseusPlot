...
![](reference/figures/README-plot_carrier_n-1.png)
...
`plot_flip()`. If you want to use a specific order instead, convert the
column to a factor. For factor columns, TheseusPlot respects the order
